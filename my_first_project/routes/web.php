...
Route::get('/Berita',[HalamanController::class,'Berita'])->name('user.berita');
Route::get('/Darah',[HalamanController::class,'Darah'])->name('user.darah');
Route::get('/Kelamin',[HalamanController::class,'Kelamin'])->name('user.kelamin');
Route::get('/Pekerjaan',[HalamanController::class,'Pekerjaan'])->name('user.pekerjaan');
Route::get('/Data',[HalamanController::class,'Kependudukan'])->name('user.kependudukan');
Route::get('/category/all',[HalamanController::class,'AllCat'])->name('all.category');
Route::post('/category/add',[HalamanController::class,'AddCat'])->name('store.category');
Route::get('/Geografis',[HalamanController::class,'Geografis'])->name('user.geografis');
Route::get('/Sejarah',[HalamanController::class,'Sejarah'])->name('user.sejarah');
Route::get('/Organisasi',[HalamanController::class,'Organisasi'])->name('user.organisasi');
Route::get('/Kontak',[HalamanController::class,'Kontak'])->name('user.kontak');
Route::get('/Desa',[HalamanController::class,'Desa'])->name('user.desa');
Route::get('/Produk',[HalamanController::class,'Produk'])->name('user.produk');
Route::get('/Galersi',[GaleriController::class,'Galeri'])->name('user.galeri');
Route::get('/Galerii',[HalamanController::class,'Galeris'])->name('user.galeri');
