    ...
    <div class="wrapper">
      ...
      @include('layouts.backend.header')   
        ...
        <div class="content-wrapper">
            ...
            <a href="{{route('add.produk')}}" class="btn btn-success">Tambah +</a>
            <table border="3">
                <tr>
                <th>No</th>
                <th>Judul Galeri</th>
                ...
                <td>
                  ...
                  <a href="{{url('/Produk/deletes/'.$category->id )}}" onclick="return confirm('Kamu Yakin Data akan dihapus')" class="btn btn-danger">Delete</a>
                </td>
                </tr>
                @endforeach
            </table>
