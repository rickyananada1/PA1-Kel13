...
<body>
    ...
    <div class="container py-1">
        ...
        <div class="row" id="cardRow">
            ...
            <div class="col-md-4 mb-4 cardColumn" data-category="{{ $produk->categoryberita->category_name }}">
                    ...
                    <div class="card-body">
                        <div class="card-text-group" style="text-align: left;">
                            ...
                            <p class="card-text card-text-category" style="display: inline-block; margin-left: 5px;">
                                {{ $produk->categoryberita->category_name }}</p>
                        </div>
                        <h4><a href="{{ route('isi_berita', $produk->slug) }}">{{ $produk->judul_berita }}</a>
                        </h4>
                    </div>
                </div>
            </div>
