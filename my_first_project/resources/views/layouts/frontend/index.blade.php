          ...
          <div class="row g-4">
              ...
              <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                  <div class="bg-white text-center h-100 p-4 p-xl-5">
                      ...
                      @if ($item->category_name === 'Makanan')
                      <a class="btn btn-outline-primary border-2 py-2 px-4 rounded-pill" href="{{url('/Produk/Category/'.$item->category_name )}}">Selanjutnya</a>
                      @endif
                      @endforeach
                  </div>
              </div>
    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-sm-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.5s">
                <h1 class="display-4 text-white" data-toggle="counter-up">{{ $kependudukan->where('Jenis_Kelamin','Laki-Laki')->count() }}</h1>
                <span class="fs-5 fw-semi-bold text-light">Laki - Laki</span>
            </div>
            <div class="col-sm-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.7s">
                <h1 class="display-4 text-white" data-toggle="counter-up">{{ $kependudukan->where('Jenis_Kelamin','Perempuan')->count() }}</h1>
