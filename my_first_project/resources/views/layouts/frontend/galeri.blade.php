              ...
              <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                <div class="col">
                  <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                      <p class="card-text">Danau Toba Indah sekali bukan?</p>
                      <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                          <button type="button" onclick="window.location.href='{{asset('FRONTEND')}}/assets/Foto/6307296.jpg'" class="btn btn-sm btn-outline-secondary">View</button>
                        </div>
                      </div>
                    </div>
                  </div>
