    ...
    <div class="container py-5">
        ...
        <div class="category-date">
            ...
            <a><p class="card-text" style="display: inline-block; margin-left: 5px; margin-right: 5px;">
              ...
              $created_at = \Carbon\Carbon::parse($galeri->created_at)->locale('id');
        ...
        <div class="owl-carousel owl-theme text-center">
            @php
            $images = json_decode($galeri->brand_image);
            @endphp
            @foreach ($images as $image)
            <div class="item d-flex justify-content-center">
                <img src="{{ asset($image) }}" alt="Image" class="img-fluid img-thumbnail w-75">
            </div>
            @endforeach
        </div>
        <div class="custom-nav text-center py-4">
            <button class="owl-prev btn btn-primaryx"><i class="fas fa-chevron-left"></i></button>
            <button class="owl-next btn btn-primaryx"><i class="fas fa-chevron-right"></i></button>
        </div>

        <p class="text-end">Mau melihat galeri lainnya ? <a href="{{route('category_galeri')}}">Klik disini</a></p>
