...
<body>
   ...
   <div class="bg-light py-5">
    <div class="col-lg-8 col-xl-6 text-start">
        <h2 class="ms-sm-5">Struktur Organisasi<br> Desa Balige II</h2>
    ...
    <div class="container">
        <div class="d-flex align-items-center justify-content-center">
          <img class="img-fluid" src="{{asset('FRONTEND')}}/assets/Foto/struktur.png" alt="">
        </div>
      </div>
<p class="text-end"><i>*Sketsa</i></p>      
