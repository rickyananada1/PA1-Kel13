    ...
    <div class="wrapper">
      ...
      @include('layouts.backend.header')   
        ...
        <div class="content-wrapper">
            ...
            @endif
            <div class="card-header"><h3>Struktur Perangkat Desa</h3></div><br><br>
            <a href="{{route('add.struktur')}}" class="btn btn-success">Tambah +</a>
            <table border="3">
                <tr>
                <th>No</th>
                <th>Nama Struktur Desa</th>
                ...
                <tr> 
                <td>{{$struktur->firstItem()+$loop->index}}</td>
                  <td>{{$category->nama}}</td>
                ...
                <td>
                  ...
                  <a href="{{url('/Struktur/deletes/'.$category->id )}}" onclick="return confirm('Kamu Yakin Data akan dihapus')" class="btn btn-danger">Delete</a>
                </td>
                </tr>
                @endforeach
            </table>
